...
## IIR filters
The selection of IIR filters for sEMG contaminant removal in this work are shown in Table1. Each IIR filter is applied only if the corresponding contaminant exists in sEMG.
